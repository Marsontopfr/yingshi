...
export ARGO_DOMAIN=${ARGO_DOMAIN:-'argo6.mister.us.kg'}   
export ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiMTRkN2FiYTY5YzY3ZWM3ODM2ZmEwZjQxMGVmNGI2NDYiLCJ0IjoiZmJmOTE0OTMtMGMxYy00ZWJjLWE2ODEtZjA3MWQ5NzUzMGJlIiwicyI6IllqYzRNVGcwT1RFdFl6QTBNaTAwTmpSaUxXRmpaVGd0TldOak9XSTROREV4T0ROaSJ9'}
export VMESS_PORT=${VMESS_PORT:-'13026'}
export TUIC_PORT=${TUIC_PORT:-'20225'}
export HY2_PORT=${HY2_PORT:-'27749'}
...
# 固定文件名
FILE_NAMES=("web" "bot" "npm" "nezha-agent")
